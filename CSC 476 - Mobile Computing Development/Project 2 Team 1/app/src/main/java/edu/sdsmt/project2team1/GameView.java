...
public class GameView extends View {
    ...
    /**
     * Zoe Millage
     * forwards a call to the cloud to download the game data
     */
    public void downloadGame(CloudCallback cloudCallback) {
        cloud.download(theGame, this, cloudCallback);
    }
    ...
    public int getTotalNumberOfRounds(){return theGame.getTotalNumberOfRounds();}
    ...
    public void setTotalNumberOfRounds(int rounds){theGame.setTotalNumberOfRounds(rounds);}



    /**
     * Marcus Kane
     * forwards to the cloud's upload end function
     * @param ended
     */
    public void uploadEnd(boolean ended) {
        cloud.uploadEnd(theGame, this, ended);
    }
     ...
     * @param cloudCallback
     */
    public void uploadGame(CloudCallback cloudCallback) {
        cloud.upload(theGame, this, cloudCallback);
    }
